...
export const hi: StringTable = {
  ...
  oracle: {
    ...
    locationLabel: 'स्थान',
    awaitsHint: 'शम्स प्रतीक्षा में है',
    redirectConversational: 'शम्स एक सच्चे प्रश्न की प्रतीक्षा में है। आपके मन पर क्या भार है?',
    redirectAmbiguous:
      'तारे आपकी मंशा सुन रहे हैं — पर और चाहिए। आपका प्रश्न किसके या किस बारे में है?',
    errSealed: 'इस क्षण के पत्र अभी अपनी मुहर नहीं खोलते। अगली नियत घड़ी पर लौटें।',
    errQuotaClosed:
      'आज के लिए द्वार बंद हो गया। शम्स प्रतिदिन निःशुल्क साधक से तीन बार बात करती है।',
    errNeedsAuth: 'शम्स एक जाना-पहचाना चेहरा माँगती है। जारी रखने के लिए साइन इन करें।',
    errNeedsVerification: 'सत्यापन की मुहर अनुपस्थित है। कृपया पुनः इंस्टॉल करके प्रयास करें।',
    errChannelInterrupted: 'शम्स तक संपर्क बाधित है। अपना कनेक्शन जाँचकर पुनः प्रयास करें।',
    quotaModalBody:
      'आकाश ने आज की अनुमति के अनुसार उतने ही प्रश्नों का उत्तर दे दिया। फ़ज्र पर लौटें — तारे स्मरण रखते हैं।',
    quotaModalDismiss: 'समझ गया',
    quotaUnlockLink: 'असीमित पहुँच खोलें',
    newQuestionTitle: 'नया प्रश्न पहचाना गया',
    newQuestionBody:
      'यह एक नया प्रश्न प्रतीत होता है। सटीक निर्णय के लिए हर प्रश्न को अपनी अलग कुंडली चाहिए।',
  },
  ...
  settings: {
    ...
    deleteAccountAction: 'हटाएँ',
    deleteAccountConfirm: 'यह आपका खाता और सभी निर्णय स्थायी रूप से हटा देगा। यह वापस नहीं आ सकता।',
    deleteAccountFailed: 'खाता नहीं हटाया जा सका। कृपया पुनः प्रयास करें।',
  },
