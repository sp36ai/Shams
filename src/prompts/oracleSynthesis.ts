/**
 * Oracle synthesis system prompt — Shams al-Asrār.
 *
 * Used by the Cloud Function synthesis layer (Claude API call).
 * Kept here as the canonical source; the functions-side copy is
 * functions/src/prompts/oracleSynthesis.ts.
 *
 * NEVER import this in React Native components — it is a server-side artifact.
 */
